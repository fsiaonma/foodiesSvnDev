zx_foodies.Utils = $hxClasses["zx_foodies.Utils"] = function() {
};
zx_foodies.Utils.__name__ = ["zx","foodies","Utils"];
zx_foodies.Utils.map = function(value,aMin,aMax,bMin,bMax) {
	if(bMax == null) bMax = 1;
	if(bMin == null) bMin = 0;
...
zx_foodies.Utils.waitAndCall = function(parent,delay,func,args) {
	createjs.Tween.get(parent).wait(delay).call(func,args);
}
zx_foodies.Utils.tintBitmap = function(src,redMultiplier,greenMultiplier,blueMultiplier,alphaMultiplier) {
...
zx_foodies.Utils.containBitmaps = function(bitmapList,spacing,isRow,dims) {
...
zx_foodies.Utils.prototype = {
	__class__: zx_foodies.Utils
}
